#!/bin/bash
# submit_polarmae20.sh — submit the 20-epoch full-1M polarmae run (DDP-capable).
#
# Usage:
#   bash gridutils/submit_polarmae20.sh <run_name> <config.yml> [n_gpus] [extra fit args...]
#
...
universe                = vanilla
notification            = never
executable              = ${LARMAMBA_REPO}/gridutils/trainjob_polarmae20.sh
